...
if __name__ == "__main__":
    ...
    anonymize_patient('/media/spgou/DATA/ZYJ/Dataset/xiangya_source_data/captk_nii_rename',
                      '/media/spgou/DATA/ZYJ/Dataset/xiangya_source_data/captk_nii_anonymized')
